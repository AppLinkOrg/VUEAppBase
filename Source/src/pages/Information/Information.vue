<template >
  <div>
    ...
    <div
      ...
      @click="pushParam('infminfo',{id:item.id})"
      style="border-bottom:1px solid #DDDDDD"
      v-for="(item, index) in yuertuijian"
      :key="index"
    >
    ...
    <div class="margin-10">
      ...
      <div class="margin-10">
        ...
        >
          <img
            :src="uploadpath+'resource/'+res.mine_bg"
            class="flex-1"
      ...
      <div style="padding-bottom:50px">
        <div
          ...
          @click="pushParam('infminfo',{id:item.id})"
          style="border-bottom:1px solid #DDDDDD ;"
          v-for="(item, qwe) in rementuijian"
          :key="qwe"
        >
          <div class="flex-1">
            <img
              :src="uploadpath+'news/'+item.cover"
              class="tuijiantu"
